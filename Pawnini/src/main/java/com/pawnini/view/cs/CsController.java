...
public class CsController {
	...
	//	}
		...
		System.out.println("InsertCsController 글 수정 처리 결과"); System.out.println("▶ dto.getCs_id(): "+dto.getCs_id());  System.out.println("▶ dto.getCs_title(): "+dto.getCs_title()); System.out.println("▶ dto.getCs_writer(): "+dto.getCs_writer()); 
		System.out.println("▶ dto.getCs_show() "+dto.getCs_show()); System.out.println("▶ dto.getCs_regdate(): "+dto.getCs_regdate());  System.out.println("▶ dto.getCs_content(): "+dto.getCs_content()); 
	...
	//글 수정 POST -- 상세페이지로 이동
		...
		public String postUpdate(CsDTO dto) throws Exception {
			...
			System.out.println("UpdateCsController 글 수정 처리 결과"); System.out.println("▶ dto.getCs_id(): "+dto.getCs_id());  System.out.println("▶ dto.getCs_title(): "+dto.getCs_title()); System.out.println("▶ dto.getCs_writer(): "+dto.getCs_writer()); 
			System.out.println("▶ dto.getCs_show() "+dto.getCs_show()); System.out.println("▶ dto.getCs_regdate() <= null이 정상임 받아지는 data가 없으니까 ><: "+dto.getCs_regdate());  System.out.println("▶ dto.getCs_content(): "+dto.getCs_content()); 
	...
	public ModelAndView getCsList(
			@RequestParam(defaultValue="CS_ALL") String searchCondition,
