...
<section>
			...
			<form name="f1rm" id="f1rm">
				<table align="center">
					...
					<tr><th>주소</th></tr>
					<tr><td>
						<input type="text" name="member_postcode" id="member_postcode" class="input" readonly size="10">
						<input type="button" onclick="searchPost()" style="cursor: pointer" value="우편번호 찾기"><br><br>
						<input type="text" name="member_f_addr" id="member_f_addr" class="input" size="60" readonly>
					</td></tr>
					<tr><th>상세주소</th></tr>
					<tr><td>
