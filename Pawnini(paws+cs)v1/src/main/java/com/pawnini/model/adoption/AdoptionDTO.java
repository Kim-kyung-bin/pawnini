...
public class AdoptionDTO {
	...
	private String adoption_f_imges;
	...
	public String toString() {
		return "AdoptionDTO [adoption_id=" + adoption_id + ", adoption_name=" + adoption_name + ", adoption_title="
				+ adoption_title + ", adoption_content=" + adoption_content + ", adoption_f_img=" + adoption_f_imges
	...
	public String getAdoption_f_imges() {
		return adoption_f_imges;
	}
	public void setAdoption_f_imges(String adoption_f_imges) {
		this.adoption_f_imges = adoption_f_imges;
	}
