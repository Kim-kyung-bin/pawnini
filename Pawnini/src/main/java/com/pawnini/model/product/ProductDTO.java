...
public class ProductDTO {
	...
	public String toString() {
		return "ProductDTO [product_id=" + product_id + ", product_f_code=" + product_f_code + ", product_s_code="
				...
				+ ", product_img2=" + product_img2 + ", product_img3=" + product_img3 + ", product_desc=" + product_desc
				+ ", product_stock=" + product_stock + ", price=" + price + ", product_date=" + product_date
				+ ", product_hits=" + product_hits + ", product_c_price=" + product_c_price + "]";
	}
